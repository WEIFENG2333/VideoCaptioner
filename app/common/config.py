...
class Config(QConfig):
    ...
    custom_model = ConfigItem("LLM", "Custom_Model", "gpt-4o-mini")
    custom_api_key = ConfigItem("LLM", "Custom_API_Key", "")
    custom_api_base = ConfigItem("LLM", "Custom_API_Base", "https://api.openai.com/v1")
